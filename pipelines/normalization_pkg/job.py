...
from pipelines.normalization_pkg.customers import customer_schema, normalize_customers
...
from pipelines.normalization_pkg.transactions import normalize_transactions, transaction_schema
