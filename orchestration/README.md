...
Dagster definitions now cover:

- simulator replay generation and online-feature refresh
- normalization, Feast application, embedding rebuilds, and vector-index refresh
- ranking training, candidate registration, and offline evaluation
- in-process API smoke checks, online guardrail summaries, and promotion-gate reports
