...
class HmNormalizationTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_normalization_outputs_expected_files_and_cleaned_rows(self) -> None:
        ...
        self.assertEqual(customer_rows[0]["club_member_status"], "Active")
        self.assertEqual(customer_rows[0]["age"], "34")
        self.assertEqual(transaction_rows[0]["event_time"], "2020-09-20T00:00:00Z")
        self.assertTrue(transaction_rows[0]["event_id"])
        self.assertEqual(image_rows[0]["article_id"], "108775015")
        self.assertTrue((self.normalized_root / "products" / "profile.json").exists())

    def test_validation_passes_for_normalized_fixture(self) -> None:
        ...
        report_path = self.reports_root / "data_quality" / "hm_normalized_validation.json"
