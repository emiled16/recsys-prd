...
class OnlineFeatureComputationTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_computes_online_feature_snapshots(self) -> None:
        ...
        self.assertEqual(session_features["cart_add_count_30m"], 1)
        self.assertTrue(session_features["recent_search_terms"])

        customer_features = customer_payload["0001"]
        self.assertEqual(customer_features["purchase_count_30d_rt"], 1)
        self.assertEqual(customer_features["cart_add_count_7d_rt"], 1)

        article_features = article_payload["108775015"]
        self.assertEqual(article_features["purchase_count_7d_rt"], 1)
        self.assertTrue(article_features["is_in_stock_rt"])
