...
class FeatureParityValidationTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.features_root = Path(self.tmp_dir.name) / "features"
    ...
    def test_validates_feature_parity_and_freshness(self) -> None:
